...
export function Homepage() {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="py-14 bg-secondary dark:bg-gray-900 w-full mt-20">
        ...
        <div className="flex flex-col w-4/5 mt-20 mx-auto">
      ...
      <h1 className="lg:text-heroText text-heroResponsive font-bold text-black  dark:text-white text-center mt-20">
        Educational Tips{" "}
      ...
      {/* Best Course */}
      <div className="bg-green-100 dark:bg-textDark  p-6 rounded-lg px-5 py-8 w-4/5 mx-auto">
        <h2 className="text-3xl font-bold mb-8 dark:text-textBlack">
