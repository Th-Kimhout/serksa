...
export default function InstructorPage() {
  return (
    ...
    <h1 className='text-green-800 font-bold text-2xl ms-48'>Instructor</h1>
    <section className='w-4/5 mx-auto'>
    <div className='grid grid-cols-1 lg:grid-cols-2 ml-5 bg-slate-600 w-3/6'>
        ...
        <div className='h-72 w-96 pt-10 ms-10'>
    ...
    <section className='w-3/5 ms-48 mt-10 ps-12'>
    ...
    <h2 className='font-bold text-3xl ms-48 text-green-600 mt-10'>More Course by Prashant Kumar singh</h2>
