...
export default function InstructorPage() {
  return (
    ...
    <h1 className='text-primary font-bold text-2xl ms-32'>Instructor</h1>
    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 w-3/6'>
        ...
        <div className='h-72 w-96 pt-10 ms-16'>
          ...
          <p className='text-textGray font-bold'>software Developer</p>
          <ul className="flex items-center space-x-3 md:order-3 mt-5">
                <li>
                  <a
                    href="#"
                    title=""
              ...
              <div className='mt-5'>
              <button type="button" class="text-blueLight bg-blue-200 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-s-lg text-sm px-5 py-2.5  mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-textGray dark:hover:border-gray-600 dark:focus:ring-textGray">Course</button>
              <button type="button" class="text-textBlack bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-e-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-textGray dark:hover:border-gray-600 dark:focus:ring-textGray">10</button>
              </div>
        </div>
    </div>
    </section>
    ...
    <h2 className='font-bold text-3xl ms-32 text-primary mt-10'>More Course by Prashant Kumar singh</h2>
      ...
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg cursor-pointer hover:shadow overflow-hidden">
        ...
        <div className="p-5 relative">
          ...
          <div className="flex items-center mt-4">
            <img className="w-10 h-10 rounded-full" src="src/assets/Image/profile.jpg" alt="Instructor Photo" />
            <div className="ml-3">
