...
export default function MyLearning() {
  return (
    <>
     <section className="bg-teal-600 py-5 rounded-xl mx-10 md:mx-20 my-10">
  <div className=" px-4 ">
    ...
    <a as={Link} to="#" >
      <button className="bg-green-300 text-blue-600 px-3 md:px-6 py-1 md:py-2 rounded-md shadow-md font-semibold text-lg" >Join Now</button> 
    </a>
  </div>
</section>
{/* continue watching */}
<section className="mx-10 md:mx-20 mb-5 md:mb-10">
  <h2 className="text-xl md:text-2xl font-bold mb-10 dark:text-gray-50">Continue Watching</h2>
