            ...
            <div class="bg-slate-50 rounded-lg px-5 pt-5 w-793">
              <div class="flex flex-row justify-center">
                <div>
                  ...
                  />
                  <button
                    onclick="changePictureButton()"
                    id="change-picture-button"
                    class="bg-customGreen text-white px-3 py-2 rounded-full hover:bg-customGreenDarker transition-all duration-200;"
                  >
              ...
              <form class="py-8 px-5 h-40 mb-96 grid justify-center">
                ...
                <p class="mt-4">Name</p>
                <input
                  class="mt-2 mb-3 border border-borderColor h-8 w-96 rounded-md leading-8 px-2"
                  type="text"
                  name=""
                  id=""
                ...
                <p>Bio</p>
                <input
                  class="mt-2 mb-3 border border-borderColor h-12 w-96 rounded-md px-2 "
                  type="text"
                  name=""
                  id=""
                  placeholder="Bio....."
