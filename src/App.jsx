          ...
          <div className="flex flex-col items-center justify-between py-2 bg-white md:flex-row">
            <div className="md:w-1/2">
              ...
              <p className="mt-4 text-gray-600">
                ...
                platform offers a wide range of courses designed to help you
                gain new skills, deepen your knowledge, and achieve your goals.
              </p>
          ...
          <div className="grid grid-cols-1 gap-6 bg-white md:grid-cols-3">
            <div className="flex flex-col items-start justify-start">
              ...
              <p className="mt-2 text-gray-600">
                Our programs are set up for the student in the world to study
                far away
              </p>
            ...
            <div className="flex flex-col items-start justify-start">
              ...
              <p className="mt-4 text-gray-600">
                Look into yourself, get something in return for your
                achievements
              </p>
            </div>
          </div>
